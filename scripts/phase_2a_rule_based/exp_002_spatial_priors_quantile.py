"""
===============================================================================
SCRIPT:         exp_002_spatial_priors_quantile.py
PHASE:          Phase 2A — Statistical / Rule-Based Prior Baseline
LOCATION:       scripts/phase_2a_rule_based/exp_002_spatial_priors_quantile.py
OBJECTIVE:      Single-file executable pipeline for Phase 2A Exp 002.
                1. Checks/builds spatially-anchored 3D empirical PDF heatmaps (ref_affine=img_nii.affine).
                2. Applies Empirical Volume Quantile Matching (binarizing at percentile threshold matching Phase 1 pathology scale).
...
USAGE:          python scripts/phase_2a_rule_based/exp_002_spatial_priors_quantile.py --split val --eval
===============================================================================
"""
...
def parse_args():
    ...
    Objective:
        Parse command-line arguments for Exp 002 baseline pipeline.
    """
    parser = argparse.ArgumentParser(
        description="Phase 2A Exp 002: Empirical Volume Quantile Spatial Prior Baseline Pipeline"
    )
    parser.add_argument(
...
def main():
    """Main CLI entry point for Exp 002 Pipeline."""
    args = parse_args()
